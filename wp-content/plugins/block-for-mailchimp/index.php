...
// define('MCB_PLUGIN_VERSION', 'localhost' === $_SERVER['HTTP_HOST']  time() : '1.0.8');
...
class MCBMailChimp
{
    public function __construct()
    {
        ...
        add_action('admin_init', [$this, 'registerYVGSetting']);
        add_action('rest_api_init', [$this, 'registerYVGSetting']);
    }

    public function registerYVGSetting()
    {
