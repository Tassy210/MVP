...
$router->prefix('admin')->withPolicy('AdminPolicy')->group(function ($router) {
    ...
    $router->get('{board_id}/settings/get-board-meta', 'BoardController@getBoardMeta')->int('board_id');
    $router->post('{board_id}/settings/authentication-permission', 'BoardController@setAuthenticationPermission')->int('board_id');
