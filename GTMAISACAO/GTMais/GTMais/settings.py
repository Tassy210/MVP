"""
Django settings for GTMais project.
...
SECRET_KEY = 'django-insecure-ttm7p65cpub*ukn=@%e6nacgasdvexi2idqh)0s^9vp@+r5t@9'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': 'C:/xampp/htdocs/GTMAISACAO/GTMais/error.log',
        },
    },
    'loggers': {
        'django': {
